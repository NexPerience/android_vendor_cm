...
PRODUCT_PROPERTY_OVERRIDES += \
    ro.rommanager.developerid=TeamMEX
endif
...
ifdef CM_RELEASE
    ...
    ifeq ($(PRODUCT_VERSION_MINOR),0)
        ...
        CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date -u +%Y%m%d)-$(shell date -u +%H%M%S)-$(CM_BUILDTYPE)-$(CM_BUILD)$(CM_EXTRAVERSION)-Build_N°.$(XPerience_build)
    endif
endif
